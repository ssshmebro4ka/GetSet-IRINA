package com.example.getset.presentation.home
...
fun HomeScreen(navController: NavHostController) {
    ...
    Scaffold(
                ...
                items.forEachIndexed { index, item ->
                    NavigationBarItem(
                        ...
                        label = {
                            Text(
                                text = item,
                                color = if (selectedItem == index) Color.White else Color(0xFF79A326)
                            )
                        },
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(15.dp))
            Button(
                onClick = { navController.navigate(Screen.MyPurposeTrain.route) },
                colors = ButtonDefaults.buttonColors(
                    containerColor = Color(0xFF117C00)
                ),
                shape = RoundedCornerShape(10.dp),
            ...
            Spacer(modifier = Modifier.height(15.dp))
            Button(
                onClick = { navController.navigate(Screen.Stopwatch.route) },
                colors = ButtonDefaults.buttonColors(
                    containerColor = Color(0xFF117C00)
                ),
                shape = RoundedCornerShape(10.dp),
